...
\protect\phantomsection\label{visual-example-1}
\emph{Video: Player has clear chance but fails to shoot}
\end{frame}

\begin{frame}{Visual Example 2}
\protect\phantomsection\label{visual-example-2}
\emph{Video: Multiple shots from same attacking sequence w/ xG that add
over 1}
\end{frame}

\begin{frame}{Our Target Metric: xG+}
\protect\phantomsection\label{our-target-metric-xg}
\begin{itemize}
\tightlist
\item
...
\protect\phantomsection\label{estimating-xshot}
\begin{itemize}
\tightlist
\item
...
\begin{frame}{Results}
\protect\phantomsection\label{results-1}
\begin{columns}[c]
  \column{0.4\textwidth}
